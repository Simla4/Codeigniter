...
<head>
  ...
  <title>Simla Beken | Yönetici Giriş</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/back/'); ?>/ower_components/Ionicons/css/ionicons.min.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Yazar Girişi</b></a>
  </div>
  <div class="login-box-body">
    <p class="login-box-msg">Yazar Giriş Formu</p>
